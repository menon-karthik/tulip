#ifndef CM_DARPASIMPLE_CODE2_H
#define CM_DARPASIMPLE_CODE2_H
...
class cm_darpaSimple_code2: public cmModel{
  public:
    
  	//! Default constructor
  	cm_darpaSimple_code2();
    //! Virtual destructor
    virtual ~cm_darpaSimple_code2();

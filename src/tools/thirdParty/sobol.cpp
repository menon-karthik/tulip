...
//  Purpose:
//
//    I8_SOBOL_MAX returns the maximum of two I8's.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
//
//    Output, long long int I8_SOBOL_MAX, the larger of I1 and I2.
//
{
  if ( i2 < i1 ) 
  {
...
//  Purpose:
//
//    I8_SOBOL_MIN returns the smaller of two I8's.
//
//  Licensing:
//
//    This code is distributed under the GNU LGPL license. 
...
long long int i8_sobol_uniform ( long long int a, long long int b, int *seed )

//****************************************************************************80
//
//  Purpose:
//
//    I8_SOBOL_UNIFORM returns a scaled pseudorandom I8.
//
//  Discussion:
//
//    The pseudorandom number should be uniformly distributed
...
//  Scale R to lie between A-0.5 and B+0.5.
//
  r = ( 1.0 - r ) * ( ( double ) ( i8_sobol_min ( a, b ) ) - 0.5 ) 
    +         r   * ( ( double ) ( i8_sobol_max ( a, b ) ) + 0.5 );
//
//  Use rounding to convert R to an integer between A and B.
//
  value = r8_sobol_nint ( r );

  value = i8_sobol_max ( value, i8_sobol_min ( a, b ) );
  value = i8_sobol_min ( value, i8_sobol_max ( a, b ) );
...
double sobol_uniform(double sbl_val, double max, double min){
//****************************************************************************80
//
//  Purpose:
//
//       sobol_uniform returns a scaled value from a uniformly-distributed 
//       variable
//
//       Added by Sean Breckling for use in TULIP
    double out;
    out = min + (max - min) * sbl_val;
    return out;

}

/*
double sobol_gaussian(double sbl_val, double max, double min){
//****************************************************************************80
//
//  Purpose:
//
//       sobol_uniform returns a value normally-distrubted variable
//
//       Added by Sean Breckling for use in TULIP
    double out;
    out = min + (max - min) * sbl_val;

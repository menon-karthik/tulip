...
long long int i8_sobol_max ( long long int i1, long long int i2 );
long long int i8_sobol_min ( long long int i1, long long int i2 );

void i8_sobol ( int dim_num, long long int *seed, double quasi[ ] );
double *i8_sobol_generate ( int m, int n, int skip );
long long int i8_sobol_uniform ( long long int b, long long int c, int *seed );

/*float r4_abs ( float x );
int r4_nint ( float x );
float r4_uniform_01 ( int *seed );*/

double r8_sobol_abs ( double x );
int r8_sobol_nint ( double x );
double r8_sobol_uniform_01 ( int *seed );

double sobol_uniform(double sbl_val, double max, double min); //New

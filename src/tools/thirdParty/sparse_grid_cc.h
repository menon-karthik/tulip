#ifndef SPARSE_GRID_CC_H
#define SPARSE_GRID_CC_H

int*    abscissa_level_closed_nd ( int level_max, int dim_num, int test_num, int test_val[] );
double  cc_abscissa ( int order, int i );
double* cc_weights ( int n );
void    comp_next ( int n, int k, int a[], bool *more, int *h, int *t );
int     i4_max_SG ( int i1, int i2 );
int     i4_min_SG ( int i1, int i2 );
...
double  monomial_quadrature ( int dim_num, int expon[], int point_num, double w[], double x[] );
